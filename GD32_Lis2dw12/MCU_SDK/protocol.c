...
const DOWNLOAD_CMD_S download_cmd[] =
{
  ...
  {DPID_X_VALUE, DP_TYPE_VALUE},
  {DPID_Y_VALUE, DP_TYPE_VALUE},
  {DPID_Z_VALUE, DP_TYPE_VALUE},
};
...
void all_data_update(void)
{
    ...
    mcu_dp_value_update(DPID_X_VALUE,当前X); //VALUE型数据上报;
    mcu_dp_value_update(DPID_Y_VALUE,当前Y); //VALUE型数据上报;
    mcu_dp_value_update(DPID_Z_VALUE,当前Z); //VALUE型数据上报;
